...
{
    public partial class FormReporteVentasXE : Form
    {
        FacturaService oFactura = new FacturaService();
        public FormReporteVentasXE()
        {
            InitializeComponent();
        }
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            this.dtVentasXEmpleadoBindingSource.DataSource = oFactura.RecuperarVentasXEmpleado(desde, hasta, nombre, apellido, alta_desde, alta_hasta);
            this.rvVentasXE.RefreshReport();
        }
        ...
        private void rvVentasXE_Load(object sender, EventArgs e)
        {
